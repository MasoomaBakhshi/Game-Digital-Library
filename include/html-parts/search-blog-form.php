...
<form action="../../include/controller/search_blog_process.php" name="delete" class="form-horizontal" method="post" onsubmit="return checksearchblog()">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-default" name="delete-blog">Search Blog</button>
                    </div>
                  </div>                  
                </form>
