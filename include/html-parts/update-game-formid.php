...
<ol class="breadcrumb">
    ...
    <li ><a class="select" href="../../public/pages/games-mang.php">Game-Managment</a></li>
</ol>
<?php
		user_message();
	?>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10" >
                      ...
                      <a href="../../public/pages/game-mang.php" class="btn btn-default">Back</a>
                    </div>
                  </div>                  
                </form>
                <?php endforeach; ?>
