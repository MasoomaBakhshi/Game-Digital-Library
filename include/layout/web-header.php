...
$(document).ready(function() {
 $(function()
    {
        $('.overlay').colorbox({opacity:0.3,width:"100%",transition:'fade',top:'0%'});
    });
 var nav = $('nav');
...
<body>
    ...
    <span class="sr-only">Toggle Dropdown</span>
                     ...
                     <ul class="dropdown-menu">
                      <li><a href="profile.php" title="Profile Page"><span class="web-nav-icon  glyphicon glyphicon-user"></span>  Profile</a></li>
